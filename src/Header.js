    ...
    return ( 
        <header className='containter px-5 py-5 md:pb-[120px] md:flex md:items-start lg:items-end md:flex-row-reverse'>
          ...
          <div className='secondaryFont text-center md:text-left py-5'>
            <h2 className='text-lg md:text-[22px] tracking-wider'>Front-end developer</h2>
            ...
            <div className='flex flex-col mt-5 md:mt-10 gap-3 md:flex-row'>
              <ButtonStructure content={"Hire Me"} theme={"Wblack"} img={require('./images/arrow-right.png')}/>
              <ButtonStructure content={"Projects"} theme={"white"} img={require('./images/forward.png')}/>
            </div>
