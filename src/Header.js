    ...
    return ( 
        <header className='containter px-5 py-5 md:pb-[120px] md:flex md:items-start lg:items-end md:flex-row-reverse'>
          ...
          <div className='secondaryFont text-center md:text-left py-5'>
            <h2 className='text-lg md:text-[22px] tracking-wider'>Web developer</h2>
            ...
            <p className='max-w-[530px] leading-[24px] tracking-wider'>Hi, I'm Hamza Husić. A passionate Web developer based in Tuzla, Bosnia and Herzegovina</p>
