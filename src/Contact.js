const Contact = () => {
    return ( 
        <section className='bg-white'> 
            <div className='containter text-black  md:pt-[94px] md:pb-[140px] py-10 md:py-0 px-5' id='lets-chat'>
                ...
                <div className='flex justify-between items-center pt-8 flex-col lg:flex-row'>
                    ...
                    <div>
                        <form action="" className='formW flex flex-col py-10 lg:py-[38px] px-5 sm:px-10 lg:px-[45px] shadow-2xl w-[310px] sm:w-[380px] md:w-[650px]'>
                            ...
                            <input type="text" name="name" id="name" placeholder='John Doe' className='border-b-[1px] border-black secondaryFont tracking-wider font-thin outline-none py-3 px-2' required/>
                            <label htmlFor="email" className='pt-[40px] tracking-[5px]' >Email</label>
                            <input type="text" name="email" id="email" placeholder="example@yourdomain.com " className='border-b-[1px] border-black secondaryFont tracking-wider font-thin outline-none py-3 px-2' required/>
                            <label htmlFor="message" className='pt-[40px] pb-[50px] tracking-[5px]'>Message</label>
                            <textarea type="text" name="message" id="message" placeholder="Hi there ..." rows="7"  className='border-[1px] border-black secondaryFont tracking-wider font-thin outline-none py-3 px-2 w-full' required/>
