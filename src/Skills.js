...
const Skills = () => {
    return ( 
        <section className='bg-[#0C0B0B]'>
            <div className='containter text-white px-5 md:pt-[94px] md:pb-[170px] pt-10 pb-20'>
                <div className='flex justify-between pb-24 md:pb-48'>
                    ...
                    <ButtonStructure content={"Download CV"} img ={null} theme={"black"} href={CV} download={true} title={"CV - Hamza Husic"}/>
                </div>
